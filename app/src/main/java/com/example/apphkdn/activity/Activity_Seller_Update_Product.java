...
//                Toast.makeText(Activity_Seller_Update_Product.this,CategoryID,Toast.LENGTH_SHORT).show();
                new UpdateTask().execute(id_product,Name,Price,CategoryID,Decs,NumberSell);
    ...
    private class UpdateTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                e.printStackTrace();
                Toast.makeText(Activity_Seller_Update_Product.this, "Error parsing JSON", Toast.LENGTH_SHORT).show();
            }
        }
    }

...
public class RequestDB {
    ...
    public static void GetUSer(Context context, String url, String email){
                    ...
                    for (int i = 0; i < response.length(); i++){
                        try {
                            ...
                            if (object.getInt("role") == 3){
                                ...
                                editor.putString("imgUS", object.getString("imgUS"));
                                editor.apply();
                                Intent intent = new Intent(context, RegistorSellerActivity.class);
                                context.startActivity(intent);
                            } else{
                                SharedPreferences preferences = context.getSharedPreferences("MyProfile", MODE_PRIVATE);
                                SharedPreferences.Editor editor = preferences.edit();
